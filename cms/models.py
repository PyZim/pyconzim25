...
class Page(models.Model):
    ...
    font_icon_code = models.CharField(
        max_length=200,
        default="fa-brands fa-python",
        help_text="The font icon for the page, use the following format - fa-brands fa-python",
    )
    content = MarkdownxField(
        default="",
        help_text="[Supports Markdown] - Content for the page",
        null=False,
        blank=False,
    )
    event_year = models.ForeignKey(
        EventYear, on_delete=models.CASCADE, default="2024", related_name="pages"
    )
