...
def get_speakers_for_homepage():
    queryset = (
        ...
        .annotate(
            ...
            sort_priority=Case(
                ...
                When(
                    user__proposals__talk_type__in=["Short Talk", "Long Talk"], then=2
                ),
    ...
    keynote_speakers = [
        speaker for speaker in unique_speakers if speaker.is_keynote_speaker
    ]

    # Separate and prioritize Sponsored Talk speakers
    sponsored_speakers = [
        speaker for speaker in unique_speakers if speaker.sort_priority == 1
    ]
    ...
    other_speakers = [
        ...
        if not speaker.is_keynote_speaker and speaker.sort_priority != 1
    ]
