...
urlpatterns = [
    ...
    path(
        "accepted_talks/",
        login_required(views.AcceptedTalksView.as_view()),
        name="accepted_talks",
    ),
    ...
    path(
        "<str:pk>/talk_details/",
        login_required(views.TalkDetailView.as_view()),
        name="talk_details",
    ),
    re_path(
        r"^(?P<pk>[\w-]+)/detail/$",
        (views.TalksDetailView.as_view()),
        name="talk_detail",
    ),
    ...
    path(
        "<str:pk>/invite-speaker/",
        views.send_speaker_invitation,
        name="send_speaker_invitation",
    ),
    ...
    path(
        ...
        reviewed_talks_by_category,
        name="reviewed_talks_by_category",
    ),
    path(
        "reviewed_by_type/", views.reviewed_talks_by_type, name="reviewed_talks_by_type"
    ),
]
