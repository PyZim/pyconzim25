...
class ReviewForm(forms.ModelForm):
    ...
    speaker_expertise = forms.ChoiceField(
        choices=SCORE_CHOICES, label="Speaker Expertise"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                Column(
                    "speaker_expertise",
                    css_class="form-control form-control-md form-control-lg rounded-0 g-mb-25",
                ),
                Column(
                    "depth_of_topic",
                    css_class="form-control form-control-md form-control-lg rounded-0 g-mb-25",
...
class DocumentForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        proposal = kwargs.pop(
            "proposal", None
        )  # Expecting 'proposal' to be passed as a kwarg
...
class ExportFieldsForm(forms.Form):
    ...
    export_format = forms.ChoiceField(
        choices=EXPORT_FORMAT_CHOICES, required=True, widget=forms.RadioSelect
    )
