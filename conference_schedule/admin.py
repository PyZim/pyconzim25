...
class TalkScheduleAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        ...
        return queryset.select_related(
            "talk", "allocated_room", "conference_day"
        ).order_by("conference_day__actual_date", "start_time")
...
class ScheduleVisibilityAdmin(admin.ModelAdmin):
    ...
    def make_not_live(self, request, queryset):
        ...
        self.message_user(
            request, "The schedule is now hidden from all users except superusers."
        )
